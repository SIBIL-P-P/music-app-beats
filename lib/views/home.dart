...
import 'package:beats_app/consts/text%20style.dart';
import 'package:beats_app/views/player.dart';
                  ...
                  itemBuilder:( BuildContext context, int index) {
                    return Container(
                      ...
                      child: Obx(
                          ...
                          trailing:controller.playIndex.value == index && controller.isPlaying.value? const
                           Icon(Icons.play_arrow,color: whiteColor,size: 26,):null,
                          onTap:(){
